...
# @pytest.mark.skip("TODO")
def test_empty_names(planets):
    names = []
    assert direct_flights(planets, names) == "null"


# @pytest.mark.skip("TODO")
def test_duplicate_names(planets):
    names = ["Narnia", "Narnia"]
    assert direct_flights(planets, names) == "null"


# @pytest.mark.skip("TODO")
def test_round_trip(planets):
    names = ["Narnia", "Naboo", "Narnia"]
    assert direct_flights(planets, names) == 500
